//This algorithm is sSimilar to SCAN but reverses direction at the last request instead of going to the disk end.
...
//	total = total + hm;
//	head=maxc;
	printf("Reached to Right End Last Request Served\n");
